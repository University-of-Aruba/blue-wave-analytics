...
- [blue_wave_squad.csv](https://github.com/rendell/blue-wave-analytics/blob/main/episodes/data/blue_wave_squad.csv) the plain-text version, one flat table
- [blue_wave_squad.xlsx](https://github.com/rendell/blue-wave-analytics/raw/main/episodes/data/blue_wave_squad.xlsx) the Excel version, with two sheets, `curacao` and `aruba`
- [blue_wave_squad.sav](https://github.com/rendell/blue-wave-analytics/raw/main/episodes/data/blue_wave_squad.sav) the SPSS version, so you can prove to yourself that R opens your existing files
