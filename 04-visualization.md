...
both datasets. We read them straight from the course repository on GitHub, so nothing needs to
be in your `data` folder for this episode:
...
Rather than accepting the default palette, set one deliberately. This is the
palette used for the figures in this lesson:
