...
Look at that output. It is the same data. You did not convert anything, you did
not export to CSV first, and you did not open SPSS. R reads your existing files
as they are.
...
For character columns you get the length and type. Notice that most of this
dataset is character, which is normal for squad and survey data and is the
reason frequency tables matter more here than means.
